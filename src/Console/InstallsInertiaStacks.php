...
trait InstallsInertiaStacks
{
    ...
    protected function installInertiaVueStack()
    {
        ...
        // Middleware...
        $this->installMiddleware('\App\Http\Middleware\HandleInertiaRequests::class', 'SubstituteBindings::class');
        $this->installMiddleware('\Illuminate\Http\Middleware\AddLinkHeadersForPreloadedAssets::class', '\App\Http\Middleware\HandleInertiaRequests::class');
